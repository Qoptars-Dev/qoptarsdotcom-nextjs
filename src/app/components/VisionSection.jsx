...
export default function VisionSection({ flip, imageAlt, title, text1, text2 }) {
    ...
    return(
        ...
        >
            <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex ${containerClasses}`}>
                ...
                <img src="images/vision.webp" alt={imageAlt} className="w-full h-auto md:h-full md:w-auto mx-auto rounded-sm object-cover" />
                </div>
