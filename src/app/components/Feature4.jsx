  ...
  return (
    <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col-reverse md:flex-row 2xl:py-24`}>
      ...
      <div className="md:w-1/2 p-6">
        ...
        <h2 className="text-3xl font-Mont font-medium mb-3">Exceptional Operational Efficiency</h2>
        <p className="text-gray-700 mb-3 text-base md:text-xl font-Mont font-normal">
        30-mins flight duration let you cover more ground In each fight, for surveying of up to 1.5 square Kilometers in one go. With 3 batteries,
        You get upto 5 square kms.
        </p>
