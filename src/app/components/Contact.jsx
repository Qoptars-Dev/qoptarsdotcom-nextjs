    ...
    <div className="w-3/4 mx-auto pb-20 flex flex-col md:flex-row justify-around">
      ...
      >
        ...
        <div className="py-5 flex gap-4">
          ...
          >
            {" "}
            <img className="w-10" alt="Qoptars Instagram" src="images/social-media/instagram.png" />
          </a>
          <a
          ...
          >
            {" "}
            <img className="w-10" alt="Qoptars LinkedIn" src="images/social-media/linkedin.png" />
          </a>
        </div>
      </motion.div>
      <iframe
