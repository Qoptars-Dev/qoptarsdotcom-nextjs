  ...
  return (
    <Carousel slide={true} slideInterval={3500} className="h-[70vh] md:h-[90vh] mb-10">
      <div className="h-full">
        <img src="images/IMG_5055.webp" alt="AirSonic S FPV" className="h-full w-full object-cover" />
        <div className="absolute top-1/2 left-1/2 block w-full -translate-x-1/2 -translate-y-1/2 text-gray-200 text-5xl md:text-7xl text-center font-Mont font-medium">
          <p>AirSonic S</p>
      ...
      <div className="h-full">
        <img src="images/vayu.webp" alt="Vayu Copter Drone" className="object-cover w-full h-full" />
